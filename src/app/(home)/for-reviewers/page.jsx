const page = () => {
  return (
    <section id="reviewers" className="space-y-3">
      <h1 className="font-roboto text-4xl font-medium">Reviewers</h1>
      <h6>1. Respond Promptly to Invitations</h6>
      <p>
      ...
      <h6>10. Give Credit Where It’s Due</h6>
      <p>
        If a paper you’re reviewing is really good and an excellent addition to
        the existing literature, don’t be afraid to say so.
      </p>
      <div id="guide-to-reviewers" className="-scroll-mt-3"></div>
      <h6>Step by Step Guide to Reviewers</h6>
      <p>
        ...
        It is also important at this stage to declare any potential conflicts of
        interest.
      </p>
      <h6>Overview of the Review Report Format</h6>
      <p>
        The structure of the review report varies between journals. Some follow
        an informal structure, while others have a more formal approach.
      </p>
      <h6>Informal Structure</h6>
      <p>
        Many journals don't provide criteria for reviews beyond asking for your
        'analysis of merits'. In this case, you may wish to familiarize yourself
        with examples of other reviews done for the journal, which the editor
        should be able to provide or, as you gain experience, rely on your own
        evolving style.
      </p>
      <h6>Formal Structure</h6>
      <p>
        Other journals require a more formal approach. Sometimes they will ask
        you to address specific questions in your review via a questionnaire. Or
        they might want you to rate the manuscript on various attributes using a
        scorecard. Often you can't see these until you log in to submit your
        review. So when you agree to the work, it's worth checking for any
        journal-specific guidelines and requirements. If there are formal
        guidelines, let them direct the structure of your review.
      </p>
      <h6>In Both Cases</h6>
      <p>
        Whether specifically required by the reporting format or not, you should
        expect to compile comments to authors and possibly confidential ones to
        editors only.
      </p>
      <h6>The First Read-Through</h6>
      <p>
      ...
      <h6>First Read Considerations</h6>
      <div>
        <p>
          Keep a pen and paper handy when skim-reading. Try to bear in mind the
          following questions - they'll help you form your overall impression:
        </p>
        <ul className="list-disc ml-8">
          <li>
            What is the main question addressed by the research? Is it relevant
            and interesting?
          </li>
          <li>
          ...
          <li>
            ...
            consensus, do they have a substantial case? If not, what would be
            required to make their case credible?
          </li>
          <li>
      ...
      <h6>Spotting Potential Major Flaws</h6>
      <p>
      ...
      <h6>Examples of Possibly Major Flaws Include:</h6>
      <div>
        <ul className="list-disc ml-8">
          <li>
        ...
        <p>
          If experimental design features prominently in the paper, first check
          that the methodology is sound - if not, this is likely to be a major
          flaw.
        </p>
      </div>
      <h6>You Might Examine:</h6>
      <ul className="list-disc ml-8">
        ...
        <li>
          ...
          sufficient descriptive elements and appropriate quotes from interviews
          or focus groups.
        </li>
      </ul>

      <h6>Major Flaws in Information</h6>
      <div>
        <p>
        ...
        <p>
          If you find a major problem, note your reasoning and clear supporting
          evidence (including citations).
        </p>
      </div>
      <h6>Concluding the First Reading</h6>
      <p>
        ...
        the first summarizing the research question addressed and the second the
        contribution of the work. If the journal has a prescribed reporting
        format, this draft will still help you compose your thoughts.
      </p>
      <h6>The First Paragraph</h6>
      <div>
        <p>
        ...
        <ul className="list-disc ml-8">
          ...
          <li>
            Focus on successful aspects of the paper so the author gets a sense
            of what they've done well
          </li>
        </ul>
      </div>
      <h6>The Second Paragraph</h6>
      <div>
        <p>
      ...
      <h6>Rejection after the First Reading</h6>
      <p>
      ...
      <h6>Before Starting the Second Read-Through</h6>
      <p>
        Once the paper has passed your first read and you've decided the article
        is publishable in principle, one purpose of the second, detailed
        read-through is to help prepare the manuscript for publication. Of
        course, you may still decide to reject it following a second reading.
      </p>
      <p>
      ...
      <div>
        ...
        <ul className="list-disc ml-8">
          ...
          <li>
            ...
            them off or have them in view on a second computer monitor or window
          </li>
        </ul>
        <p>
      ...
      <h6>Doing the Second Read-Through</h6>
      <div>
        <p>
          ...
          language and content. With regard to the argument’s construction, you
          should identify:
        </p>
        <ul className="list-disc ml-8">
        ...
        <ul className="list-disc ml-8">
          ...
          <li>Does the abstract provide an accessible summary of the paper?</li>
      ...
      <h6>Check the Language</h6>
      <p>
        Not every submission is well written. Part of your role is to make sure
        that the text’s meaning is clear.
      </p>
      <div>
        <p>
          If the article is difficult to understand, you should have rejected it
          already. However, if the language is poor but you understand the core
          message, see if you can suggest improvements to fix the problem:
        </p>
        <ul className="list-disc ml-8">
          <li>
            Are there certain aspects that could be communicated better, such as
          ...
          <li>
            Would you consider looking at the paper again once these issues are
            dealt with?
          </li>
        </ul>
      </div>
      <h6>On Grammar and Punctuation</h6>
      <p>
        ...
        at a high standard before publication. However, if you spot grammatical
        errors that affect clarity of meaning, then it's important to highlight
        these. Expect to suggest such amendments - it's rare for a manuscript to
        pass review with no corrections. The Second Read-Through: Section by
        Section Guidance
      </p>
      <div className="ml-8 space-y-3">
        <h6>1. The Introduction </h6>
        <div>
          ...
          <ul className="list-[circle]  ml-8">
            ...
            <li>
              Establishes the originality of the research aims by demonstrating
              the need for investigations in the topic area.
            </li>
            <li>
              Gives a clear idea of the target readership, why the research was
              carried out and the novelty and topicality of the manuscript.
            </li>
          </ul>
        </div>
        <h6>Originality and Topicality</h6>
        <p>
        ...
        <p>
          ...
          gathering techniques or to research in indirectly related fields that
          suggest the topic needs revisiting. Clearly, authors can only do this
          by referencing recent literature. Obviously, where older research is
          seminal or where aspects of the methodology rely upon it, then it is
          perfectly appropriate for authors to cite some older papers.
        </p>
        <p>
          Aims : It's common for the introduction to end by stating the research
          aims. By this point you should already have a good impression of them
          - if the explicit aims come as a surprise, then the introduction needs
          improvement.
        </p>
        <h6>2. Materials and Methods</h6>
        <div>
          <p>
            Academic research should be replicable, repeatable and robust - and
            follow best practice. Replicable research this makes sufficient use
            of:
          </p>
          <ul className="list-[circle]  ml-8">
          ...
          <p>
            ...
            and that the same experiment could be repeated by other researchers
            - and result in the same outcome. Statistical analyses will not be
            sound if methods are not replicable. Where research is not
            replicable, the paper should be recommended for rejection.
          </p>
        </div>
        <h6>Repeatable Methods</h6>
        <p>
          These give enough detail so that other researchers are able to carry
          out the same research. For example, equipment used or sampling methods
          should all be described in detail so that others could follow the same
          steps. Where methods are not detailed enough, it's usual to ask for
          the methods section to be revised.
        </p>
        <h6>Robust Research</h6>
        <p>
          ...
          revision. You should also consider whether there is any in-built bias
          not nullified by the control experiments.
        </p>
        <h6>Best Practice</h6>
        <h6></h6>
        <div>
          ...
          <ul className="list-[circle]  ml-8">
            <li>
              Standard guidelines were followed (e.g. the CONSORT Statement for
          ...
          <p>
            ...
            it's usual to recommend rejection. What's more, you don't then need
            to read any further.
          </p>
        </div>
        <h6>3. Results and Discussion</h6>
        <div>
          <p>
            This section should tell a coherent story - What happened? What was
            discovered or confirmed? Certain patterns of good reporting need to
        ...
        <p>
          ...
          together into a single whole. Authors should describe and discuss the
          overall story formed. If there are gaps or inconsistencies in the
          story, they should address these and suggest ways future research
        ...
        <h6>
          5. Information Gathered:<span> Images, Graphs and Data Tables</span>
        </h6>
        <div>
          <p>
            If you find yourself looking at a piece of information from which
            you cannot discern a story, then you should ask for improvements in
            presentation. This could be an issue with titles, labels,
        ...
        <p>
          ...
          to emphasize the story they tell. This may be appropriate but only if
          authors report on how the image has been edited (e.g. by highlighting
          certain parts of an image). Where you feel that an image has been
          edited or manipulated without explanation, you should highlight this
          in a confidential comment to the editor in your report.
        </p>
        <h6>6. List of References</h6>
        <p>
          You will need to check referencing for accuracy, adequacy and balance.
        </p>
        <h6>Accuracy</h6>
        <p>
          Where a cited article is central to the author's argument, you should
          check the accuracy and format of the reference - and bear in mind
          different subject areas may use citations differently. Otherwise, it's
          the editor’s role to exhaustively check the reference section for
          accuracy and format.
        </p>
        <h6>Adequacy</h6>
        <div>
          ...
          <ul className="list-[circle]  ml-8">
            ...
            <li>
              Are there published studies that show similar or dissimilar trends
              that should be discussed?
            </li>
            <li>
              If a manuscript only uses half the citations typical in its field,
              this may be an indicator that referencing should be improved - but
        ...
        <div>
          ...
          <ul className="list-[circle]  ml-8">
            ...
            <li>
              Gives due recognition to the initial discoveries and related work
              that led to the work under assessment
            </li>
          </ul>
        </div>
        <p>
          You should be able to evaluate whether the article meets the criteria
          for balanced referencing without looking up every reference.
        </p>
        <h6>7. Plagiarism</h6>
        <p>
          By now you will have a deep understanding of the paper's content - and
          you may have some concerns about plagiarism.
        </p>
        <h6>Identified Concern</h6>
        <p>
          If you find - or already knew of - a very similar paper, this may be
          because the author overlooked it in their own literature search. Or it
          may be because it is very recent or published in a journal slightly
          outside their usual field.
        </p>
        <p>
          ...
          similar research. If so, you may ask the author to discuss their aims
          and results, or modify their conclusions, in light of the similar
          article. Of course, the research similarities may be so great that
          they render the work unoriginal and you have no choice but to
          recommend rejection.
        </p>
        <h6>Suspected Concern</h6>
        <p>
          If you suspect plagiarism, including self-plagiarism, but cannot
          recall or locate exactly what is being plagiarized, notify the editor
          of your suspicion and ask for guidance. Most editors have access to
          software that can check for plagiarism.
        </p>
        <p>
        ...
        <h6>8. Search Engine Optimization (SEO)</h6>
        <p>
        ...
        <div>
          <p>
            ...
            rankings and will influence whether the user finds and then decides
            to navigate to the main article. The title should contain the
            relevant SEO terms early on. This has a major effect on the impact
            of a paper, since it helps it appear in search results. A poor
            abstract can then lose the reader's interest and undo the benefit of
            an effective title - whilst the paper's abstract may appear in
            search results, the potential reader may go no further. So ask
            yourself, while the abstract may have seemed adequate during earlier
            checks, does it:
          </p>
          <ul className="list-[circle]  ml-8">
      ...
      <h6>How to Structure Your Report</h6>
      <p>
        If there is a formal report format, remember to follow it. This will
        often comprise a range of questions followed by comment sections. Try to
        answer all the questions. They are there because the editor felt that
        they are important. If you're following an informal report format you
        could structure your report in three sections: summary, major issues,
        minor issues.
      </p>
      <h6>Summary</h6>
      <div>
        ...
        <ul className="list-disc ml-8">
          ...
          <li>
            ...
            Is the evidence they present strong enough to prove their case? Have
            they cited all the relevant work that would contradict their
      ...
      <h6>On Presentation and Style</h6>
      <div>
        <p>
      ...
      <h6>Criticisms &amp; Confidential Comments to Editors</h6>
      <p>
        Most journals give reviewers the option to provide some confidential
        comments to editors. Often this is where editors will want reviewers to
        state their recommendation - see the next section - but otherwise this
        area is best reserved for communicating malpractice such as suspected
        plagiarism, fraud, unattributed work, unethical procedures, duplicate
        publication, bias or other conflicts of interest.
      </p>
      <p>
      ...
      <h6>The Recommendation</h6>
      <p>
        Most journals give reviewers the option to provide some confidential
        comments to editors. Often this is where editors will want reviewers to
        state their recommendation, but otherwise this area is best reserved for
        communicating malpractice such as suspected plagiarism, fraud,
        unattributed work, unethical procedures, duplicate publication, bias or
      ...
      <p>
        ...
        mind that some journals will not want the recommendation included in any
        comments to authors, as this can cause editors difficulty later for more
        advice about working with editors.
      </p>
      <p>
        You will normally be asked to indicate your recommendation (e.g. accept,
        reject, revise and resubmit, etc.) from a fixed-choice list and then to
        enter your comments into a separate text box.
      </p>
      <h6>Recommending Acceptance</h6>
      <p>
      ...
      <h6>Recommending Revision</h6>
      <p>
        Where improvements are needed, a recommendation for major or minor
        revision is typical. You may also choose to state whether you opt in or
        out of the post-revision review too. If recommending revision, state
        specific changes you feel need to be made. The author can then reply to
        each point in turn.
      </p>
      <p>
      ...
      <h6>Recommending Rejection</h6>
      <p>
        If recommending rejection or major revision, state this clearly in your
        review. When Recommending Rejection Where manuscripts have serious flaws
        you should not spend any time polishing the review you've drafted or
        give detailed advice on presentation.
      </p>
      <p>In your recommendations for the author, you should:</p>
      <ul className="list-disc ml-8">
        <li>
          Give constructive feedback describing ways that they could improve the
          research
        </li>
        <li>
        ...
        <li>
          Avoid making critical confidential comments to the editor while being
      ...
      <p>
        Remember to give constructive criticism even if recommending rejection.
        This helps developing researchers improve their work and explains to the
        editor why you felt the manuscript should not be published.
      </p>
      <h6>Working with Editors</h6>
      <p>
        ...
        exactly what it is that editors are looking for from a good peer review.
      </p>
      <h6>Your Expertise</h6>
      <p>
        When an editor invites you to review, they will mention if there is a
        particular aspect of the paper that they would like you to look at. This
        is because sometimes editors may invite reviewers with expertise in
        certain areas, e.g., the methodology or the statistics used in the study
        – even if they know you don’t work in the subject area of the
        manuscript. If that is the case, it’s good practice to state at the
        beginning of the review that you will only be commenting on that aspect
        of the paper. If you’re not sure why you were asked to review a paper,
        ask the editor who invited you to review. Editors prefer that you
        contact them with questions, rather than you not respond or not complete
        the review.
      </p>
      <h6>The Role of Your Recommendation</h6>
      <p>
        It’s down to the editors to make a decision about the paper. This will
        be based on your recommendation and comments, and their own reading. It
        is worth repeating that the editor’s decision will not always match
        yours, so you should not mention it in comments to the author.
      </p>
      <h6>Comments to Editors and Authors</h6>
      <p>
        The editor not only uses reviewer comments to help make a decision. They
        will often refer to them in their decision letter. With this in mind,
      ...
      <p>
        ...
        your comments match your recommendation. If you’re recommending that the
        paper be rejected, your comments should clearly state what the problems
        are and they should not be excessively positive or seem to contradict
        your recommendation.
      </p>
      <p>
        ...
        <br />
        Keep in mind that comments to editors should only be used for notes that
        you don’t want the authors to see. Anything that is important for the
        authors to know should be in comments to the authors, not the comments
        to the editors.
        <br />
      ...
      <div id="revised-manuscripts" className="scroll-mt-28"></div>
      <h6>How to Review Revised Manuscripts</h6>
      <div>
        <p>
      ...
      <p>
        Thus your review of a revised manuscript should be relatively quick and
        may only involve checking that certain requested actions have been done.
        Nevertheless, the aim of the review remains the same: to ensure the
        paper is of a publishable standard.
      </p>
      <p>
      ...
      <p>
        ...
        their own response comments. Some journals require authors to highlight
        the changes in their revised manuscript, which simplifies this.
      </p>
      <div id="clinical-manuscript" className="scroll-mt-28">
        <h6>For Reviewing a Clinical Manuscript</h6>
        <div className="space-y-2">
          <h6>1. Follow the basic principles of peer review</h6>
          <p>
          ...
          <h6>2. Keep the target audience in mind</h6>
          <p>
          ...
          <h6>3. Look for a well-organized structure</h6>
          <p>
            Clinical practitioners are busy and the research they read needs to
            be organized. When you are reviewing the manuscript think about how
            appealing it is. Do you find it easy to identify the key points? Is
            it clear what areas are less important and can be skimmed over by a
            busy practitioner? Is the structure of the manuscript consistent
            with that of the journal?
          </p>
          <h6>4. Consider the application to professional practice</h6>
          <p>
          ...
          <h6>5. Establish the elements of the case study</h6>
          <p>
          ...
          <h6>6. Watch out for conflicts of interest</h6>
          <p>
            ...
            be stated.
            <br />A true conflict may not exist, but reviewers should be given
            all the disclosure information. If you feel that something is
            missing, tell the editor and mention it in your review. Further, if
            you feel that you have a potential conflict of interest with the
          ...
          <p>
            ...
            even when the institutional decision was to exempt the research from
            informed consent procedures. If the statement is missing, notify the
            editor as some journals will not accept research without this
            statement.
          </p>
        </div>
      </div>
      <div id="registerd-report" className="space-y-3 scroll-mt-28">
        <h6>Reviewing Registered Reports</h6>
        <h6>Background</h6>
        <p>
        ...
        <h6>Guidelines for Reviewers</h6>
        <p>
        ...
        <div className="space-y-3">
          <p>
            ...
            2: Completed Study manuscripts will more closely resemble a regular
            article format. The manuscript will then be returned to the
            reviewers, who will be asked to appraise:
          </p>
          <ul className="ml-8">
            <li>
          ...
          <p>
            ...
            unless such tests are necessary to satisfy one or more of the Stage
            2 review criteria. Please note that editorial decisions will be
            based on adherence to the approved protocols and experimental design
            in Stage 1 and conclusions supported by data (even if they are
            negative findings) as opposed to novelty and perceived importance of
            results.
          </p>
        </div>
      </div>
