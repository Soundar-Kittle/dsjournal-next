...
// <div className="grid gap-1 text-sm md:hidden">
...
//         <th className="px-3 py-2 font-normal border-x">Revised</th>
//         <th className="px-3 py-2 font-normal border-x">Accepted</th>
