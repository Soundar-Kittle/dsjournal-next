      ...
      <div className="w-full px-6 sm:px-10 lg:px-14 py-8">
        ...
        <header className="border-b border-slate-200 dark:border-slate-800 pb-5 mb-6">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            <span className="font-semibold">Platform:</span> DS Journals (Dream Science Journals)
          </p>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            Dream Science Journals (DS Journals) is an open-access academic platform providing free
            public access to journals, articles, DOI information and archives.
          </p>
          <p className="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            Currently, the website does not require user registration or public authentication. Only
            the administrative dashboard is restricted and secured.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            At present, DS Journals does <span className="font-semibold">NOT</span> collect:
          </p>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            DS Journals may introduce optional online payment functionality in the future for
            services such as:
          </p>
          <ul className="mt-3 list-disc list-inside space-y-1 text-sm text-slate-600 dark:text-slate-300">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            Payments will be processed through secure third-party providers such as PayPal or
            equivalent PCI-compliant payment platforms.
          </p>
          ...
          <div className="mt-4 rounded-lg bg-sky-50 dark:bg-sky-950/40 border border-sky-100 dark:border-sky-900 px-4 py-3">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-sky-900/80 dark:text-sky-100">
              <li>
                DS Journals will <span className="font-semibold">NOT</span> store or process
                credit/debit card details directly.
              </li>
              <li>
                All sensitive financial information will be securely handled by PayPal or the chosen
                gateway.
              </li>
              <li>Payment providers will operate under their own privacy and security policies.</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            When payment gateways are active, cookies or session identifiers may be used to:
          </p>
          <ul className="mt-3 list-disc list-inside space-y-1 text-sm text-slate-600 dark:text-slate-300">
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            Payment data will be shared only with authorised payment processors such as PayPal and
            will not be distributed to any other third party.
          </p>
          <p className="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            By using the website and completing any future transactions, you consent to the
