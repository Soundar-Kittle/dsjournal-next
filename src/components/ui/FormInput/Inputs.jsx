...
//   // ✅ FIXED HERE: added .filter(Boolean) to remove nulls
//   const acceptedFileItems = (uploadedFiles[name] || [])
//     ?.map((file, idx) => {
//       const isFileObject = file instanceof File;
//       const fileName = isFileObject ? file.name : file;
//       const ext = fileName?.split(".").pop()?.toLowerCase();
...
//       );
//     })
//     .filter(Boolean); // ✅ This line prevents [null] from breaking the display
